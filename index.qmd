...
- Correlation do not have obvious effect on performance, additional test required

- [DIABLO]{.primary} is the best, with marginal difference to mofa + glmnet

- [MOGONET]{.quaternary} is the worst despite it is deep learning based
...
- [MOGONET]{.tertiary} performs worst, have constantly low median of sensitivity capped ~ 0.1
